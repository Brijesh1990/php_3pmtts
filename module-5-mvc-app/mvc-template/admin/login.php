...
<html lang="en">
  <head>
    ...
    <title>Fly Air reservation :: Admin Login page</title>
    <!-- Custom fonts for this template-->
    <link
      href="<?php echo $baseurl;?>vendor/fontawesome-free/css/all.min.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
                ...
                <div class="col-lg-6">
                  <div class="p-5">
                    <div class="text-center">
                      <h1 class="h4 text-gray-900 mb-4">Fly Air Admin Login!</h1>
                    </div>
                    <form class="user">
